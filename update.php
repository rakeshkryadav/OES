...
if(@$_GET['fdid'] && $_SESSION['key']=='rakesh') {
$id=@$_GET['fdid'];
...
//delete user
if(isset($_SESSION['key'])){
if(@$_GET['demail'] && $_SESSION['key']=='rakesh') {
$demail=@$_GET['demail'];
...
//remove exam
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'rmexam' && $_SESSION['key']=='rakesh') {
$eid=@$_GET['eid'];
...
//add exam
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addexam' && $_SESSION['key']=='rakesh') {
$name = $_POST['name'];
...
//add question
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addqns' && $_SESSION['key']=='rakesh') {
$n=@$_GET['n'];
$eid=@$_GET['eid'];
$ch=@$_GET['ch'];
